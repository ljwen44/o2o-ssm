...
public interface FriendMapper {
	...
	@Select("select f.*, u.uid userUUID, u.avatar, u.introduce, u.userName "
	...
	@Select("select count(*) from friend where uid=#{uid} or ruid=#{uid}")
	...
	@Delete("delete from friend where fid=#{fid}")
